...
export default function DanielaMirandaStudio() {
  ...
  return (
    <div className="relative min-h-screen">
      ...
      {/* ═══ FLOATING BUTTONS ═══ */}
      <div className="fixed bottom-5 right-5 md:bottom-7 md:right-7 z-[999] flex flex-col gap-3 items-end">
        {/* Daniela AI Chat */}
        <a href="/chat" className="w-[50px] h-[50px] md:w-[54px] md:h-[54px] rounded-full bg-gradient-to-br from-rose to-rose-dark flex items-center justify-center no-underline hover:scale-110 transition-all duration-400 shadow-[0_4px_16px_rgba(183,110,121,0.35)]" aria-label="Chat con Daniela AI">
          <span className="font-serif italic text-white text-[18px]">dm</span>
        </a>
        {/* WhatsApp */}
        <a href={wa} target="_blank" rel="noopener noreferrer" className="w-[50px] h-[50px] md:w-[54px] md:h-[54px] rounded-full bg-[#25D366] flex items-center justify-center no-underline hover:scale-110 transition-all duration-400 shadow-[0_4px_16px_rgba(37,211,102,0.3)]" aria-label="WhatsApp">
